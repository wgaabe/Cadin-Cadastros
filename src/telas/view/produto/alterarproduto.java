...
public class alterarproduto extends javax.swing.JFrame {
     ...
     */
    public alterarproduto(int codigo) {
        initComponents();
    ...
    if (codigo != 0)
        {
            ...
            Cadastrar_produto pdao = new Cadastrar_produto();
            CadProdPOJO ppojo = new CadProdPOJO();
            
            ppojo = pdao.verificar_login_usuario_unico(codigo);
            TCodProduto.setText(""+ppojo.getCodigo());
            TNomeProduto.setText(ppojo.getNome());
            TMarca.setText(ppojo.getMarca());
    ...
    private void BCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BCadastrarActionPerformed
        ...
        pj.setCodigo(Integer.parseInt(TCodProduto.getText()));
        
        
        try {
            md.verificar_campos(pj);
           int n = cp.alterar_produto(pj);
